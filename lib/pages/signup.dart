    ...
    if (password != null) {
      try {
        ...
        ScaffoldMessenger.of(context).showSnackBar((SnackBar(
            backgroundColor: Color.fromARGB(255, 72, 97, 71),
            content: Text(
        ...
        if (e.code == 'weak-password') {
          ScaffoldMessenger.of(context).showSnackBar(SnackBar(
              backgroundColor: Color.fromARGB(255, 139, 20, 20),
              content: Text(
          ...
          ScaffoldMessenger.of(context).showSnackBar(SnackBar(
              backgroundColor: Color.fromARGB(255, 134, 21, 17),
              content: Text(
                            ...
                            GestureDetector(
                              ...
                              child: Material(
                                ...
                                child: Container(
                                  ...
                                  width: 200,
                                  decoration: BoxDecoration(
                                      color: Color.fromARGB(255, 107, 15, 15),
                                      borderRadius: BorderRadius.circular(20)),
                                  child: Center(
                                      child: Text(
                                    "SIGN UP",
